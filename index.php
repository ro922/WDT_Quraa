...
<head>
    ...
    <style>
        ...
        .activity-list {
            ...
            flex-wrap: wrap;
            gap: 25px;
            /* زيّدت المسافة بين الكروت */
            justify-content: center;
        }

        .intro-section {
            padding: 100px 0;
            background: linear-gradient(rgba(0, 0, 0, 0.548), rgba(0, 0, 0, 0.7)), url('https://png.pngtree.com/thumb_back/fh260/background/20221010/pngtree-islamic-green-background-vector-image_1466928.jpg') no-repeat center center;
        ...
        .activity-item:hover {
            ...
            /* الكارت يترفع لفوق لما نحط المؤشر */
        ...
        .activity-item:hover i {
            transform: scale(1.1);
            /* الأيقونة تكبر شوية لما نحط المؤشر */
        }
            ...
            <div class="container">
                <div class="intro-content">
                    ...
                    <div class="intro-text">
                        <p>يقدم موقع قراء خدمات متعددة لكتاب الله تعالى بدءاً من المصحف الإلكتروني مع إمكانية البحث،
                            وحتى التلاوات المسجلة لأشهر القراء، بالإضافة إلى تفسير الآيات والأذكار اليومية.</p>
            ...
            <section class="user-activity-section">
                <div class="container">
                    <div class="user-welcome">
                        ...
                        <p>إزيك النهاردة؟ اتفرج على تقدمك في القرآن والأذكار</p>
                    </div>
                    <div class="activity-list">
                        ...
                        <div class="activity-item">
                            <a href="azkar.php">
                                ...
                                <h3>نشاط الأذكار</h3>
                                <p>تابع تقدمك في الأذكار اليومية</p>
                        ...
                        <div class="activity-item">
                            <a href="new_khatma.php">
                                ...
                                <p>ابدأ ختمة جديدة أو تابع ختماتك السابقة</p>
                            </a>
                        </div>
                    </div>
            </section>
        <?php } else { ?>
            <section class="user-activity-section">
                <div class="container">
                    <div class="user-welcome">
                        <h2>مرحباً!</h2>
                        <p>سجل دخول عشان تشوف تقدمك في القرآن والأذكار</p>
                        <a href="login.php" class="login-btn">سجل دخول الآن</a>
                        <a href="signup.php" class="login-btn" style="background-color: #2c3e50; margin-top: 10px;">إنشاء
                            حساب جديد</a>
                    </div>
                </div>
            </section>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section about-section">
                    <h3>عن موقع قراء</h3>
                    <p>موقع إسلامي متخصص في خدمة القرآن الكريم وعلومه، يقدم المصحف الإلكتروني، التلاوات، التفاسير،
                        والأذكار اليومية.</p>
