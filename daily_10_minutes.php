...
<head>
    ...
    <style>
        body {
            ...
            text-align: center;
            direction: rtl;
            background: url('https://t3.ftcdn.net/jpg/02/59/52/50/360_F_259525077_pMyFfvPNH6dKpdZKeoCQ6n6Bmxt5RHZ7.jpg') no-repeat center center fixed;
        ...
        .reading-section, .details {
            background: linear-gradient(135deg,rgba(240, 248, 245, 0.63),rgba(240, 248, 245, 0.63));
            border-radius: 15px;
        ...
        <section class="reading-details-section">
            <div class="container">
                ...
                <div class="reading-section">
                    <h2>اقرأ 10 دقايق في اليوم</h2>
                    <label>اختار السورة:</label><br>
                    ...
                    <div class="timer-controls">
                        <button class="timer-btn" id="startTimer">ابدأ القراءة</button>
                        <button class="timer-btn" id="stopTimer" style="display: none;">إنهاء القراءة</button>
    ...
    <script>
        ...
        stopTimerBtn.addEventListener('click', function() {
            if (isTimerRunning) {
                ...
                const progress = duration >= 10 ? 'هدف اليوم مكتمل!' : 'اقرأ المزيد عشان تكملي الهدف';
