...
<head>
    ...
    <style>
        body {
            ...
            background: url('https://media.gettyimages.com/id/1383966964/video/abstract-green-holy-quran-concept-loopable-bokeh-animation-soft-background-the-koran-cover.jpg?s=640x640&k=20&c=OOTSb0fyDkD9jEn2v2heBIIUzywCfNr0bCLNVkEVzX4=') no-repeat center center fixed;
        ...
        .container {
            ...
            margin: 50px auto;
            padding: 20px;
            background-color: rgba(231, 233, 234, 0.78);
            border-radius: 15px;
